...
void Demo::Render() {
	...
	glm::mat4 view = glm::lookAt(glm::vec3(1, 2, 3), glm::vec3(0, 0, 0), glm::vec3(0.0f, 1.0f, 0.0f));
...
void Demo::BuildColoredCube() {
	...
	int width, height;
	unsigned char* image = SOIL_load_image("kay.png", &width, &height, 0, SOIL_LOAD_RGBA);
...
int main(int argc, char** argv) {
	...
	app.Start("Texture Mapping: Draw textured cube and plane", 1440, 1280, true, false);
}
